...
export class ResolvedPos<S extends Schema = any> {
  ...
  constructor(pos: number, path: any[], parentOffset: number) {
  ...
  get parent(): ProsemirrorNode<S> {
    return this.node(this.depth);
  }

  // :: Node
  // The root node in which the position was resolved.
  get doc(): ProsemirrorNode<S> {
    return this.node(0);
  }
  ...
  marksAcross($end: ResolvedPos<S>): Mark<S>[] | undefined {
  ...
  blockRange(other: ResolvedPos<S> = this, pred?: (p: ProsemirrorNode<S>) => boolean): NodeRange<S> | null | undefined {
  ...
  static resolve<S extends Schema = any>(doc: ProsemirrorNode<S>, pos: number) {
  ...
  static resolveCached<S extends Schema = any>(doc: ProsemirrorNode<S>, pos: number) {
