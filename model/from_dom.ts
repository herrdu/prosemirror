...
export class DOMParser<S extends Schema = any> {
  ...
  parse(dom: Node, options: ParseOptions = {}) {
    let context: ParseContext = new ParseContext(this, options, false);
...
function wsOptionsFor(preserveWhitespace: "full" | boolean | null | undefined) {
...
class ParseContext {
  ...
  addElementByRule(dom: Element, rule: ParseRule) {
    ...
    if (nodeType! && nodeType!.isLeaf) {
      ...
      let contentDOM: string | ((p: Node) => Node) | null | Element | Node | undefined = rule.contentElement;
  ...
  addAll(parent: Node, sync?: any, startIndex?: number | null, endIndex?: number | null) {
