import { Selection, NodeSelection } from "../state";
import { Slice, ResolvedPos, Node as ProsemirrorNode } from "../model";
...
export class GapCursor extends Selection {
  ...
  // XXX - 错误的扩展了类型 modified by duyutao
  static findFrom($pos: ResolvedPos, dir: number, mustMove: boolean): any {
    search: for (;;) {
