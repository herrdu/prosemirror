import { Node as ProsemirrorNode, Schema } from "../model";

// Helper for creating a schema that supports tables.

function getCellAttrs(dom: HTMLElement, extraAttrs: any) {
...
function setCellAttrs(node: ProsemirrorNode, extraAttrs: { [key: string]: any }) {
...
export function tableNodes(options: {
  ...
  cellAttributes?: {
    default: any;
    getFromDOM?: (dom: Node) => any;
    setDOMAttr?: (value: any, attrs: { [key: string]: any }) => void;
  };
}) {
