import { Slice, Fragment, ResolvedPos, Schema, Node as ProsemirrorNode } from "../model";
import { ReplaceStep, ReplaceAroundStep, Mapping } from "../transform";
...
export class TextSelection<S extends Schema = any> extends Selection {
  ...
  map(doc: ProsemirrorNode<S>, mapping: Mapping) {
