...
function normalizeKeyName(name: string) {
  ...
  let alt: boolean, ctrl: boolean, shift: boolean, meta: boolean;
...
export function keydownHandler(bindings: { [key: string]: any }) {
  let map = normalize(bindings);
  return function (view: EditorView, event: KeyboardEvent) {
